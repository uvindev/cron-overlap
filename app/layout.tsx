...
export const metadata: Metadata = {
  title: "CronOverlap — simulate scheduled work before production",
  description:
    "Simulate a complete Vercel cron manifest in UTC and find start bursts, overlapping run windows, and missing release ownership.",
